...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/09/04 20:42:39 by tduquesn          #+#    #+#             */
/*   Updated: 2017/09/07 16:41:21 by ydjabri          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	printf("4 tours de fonction pour %f secondes, expect < 2 sec (pas 8, cas triviaux\n)", clocktime(start, end));
